...
export class ZanaiExtension {
  ...
  async syncContext() {
    ...
    try {
      ...
      this.showNotification(`Failed to sync context: ${error.message}`, 'error');
    }
  }
  ...
  async executeAgent() {
    ...
    try {
      ...
      this.showNotification(`Failed to execute agent: ${error.message}`, 'error');
    }
  }
  ...
  async showAgents() {
    ...
    try {
      ...
      this.showNotification(`Failed to fetch agents: ${error.message}`, 'error');
    }
  }
